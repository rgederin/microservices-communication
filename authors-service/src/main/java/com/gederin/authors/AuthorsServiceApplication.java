package com.gederin.authors;

import com.gederin.authors.grpc.GrpcAuthorsServiceImpl;
...
@Slf4j
@AllArgsConstructor
public class AuthorsServiceApplication implements ApplicationListener<ContextRefreshedEvent> {

    private final GrpcAuthorsServiceImpl grpcAuthorsService;
